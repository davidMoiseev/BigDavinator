...
public class ManipulatorSetPoints
{
    ...
    /*
     * Lowest port hole (where the cargo is placed) center on spaceship is 27.5in.
     * off the ground. Middle port hole (where the cargo is placed) center on
     * spaceship is 55.5in. off the ground. Top port hole (where the cargo is
     * placed) center on spaceship is 83.5in. off the ground. The center of the
     * lowest hatch pannel spot on spaceship is 19in. off the ground. The center of
     * the middle hatch pannel spot on spaceship is 47in. off the ground. The center
     * of the top hatch pannel spot on spaceship is 75in. off the ground.
     * 
     * Approx. 70 Deg.L (or -70 Deg.L) @ wrist to pick up cargo. Approx. 36 Deg.L
     * (or -36 Deg.L) @ wrist to place cargo. 90 Deg.L (or -90 Deg.L) @ wrist to
     * place hatches.
     */
